...
// import { EntityState, BotcraftPhysics, EPhysicsCtx } from "@nxg-org/mineflayer-physics-util";
...
//     private ectx: EPhysicsCtx;

//     private tick = 0;
//     constructor(private bot: Bot) {
//         this.physics = new BotcraftPhysics(registry(bot.version));
...
//         let simulate = previousState && !previousState.pos.equals(entity.position)
...
//             stateInfo.shift();
//             // const simVel = simState.vel.clone();
          
//             simState.merge(stateInfo[0]);
//             const simVel = entity.position.minus(simState.pos)
//             simState.vel = simVel
//             // simState.vel = simVel;
...
//                 simState.control = moves;
//                 this.physics.simulate(simState, this.bot.world);
...
//         return this.trackingData[entity.id] ? this.trackingData[entity.id].states[1].vel : null;
//     }
// }
